    ...
    public class ResolvePublishAssemblies : TaskBase
    {
        ...
        protected override void ExecuteCore()
        {
            ...
            foreach (ResolvedFile resolvedAssembly in resolvedAssemblies)
            {
                ...
                item.SetMetadata("PackageName", resolvedAssembly.Package.Id.ToString().ToLower());
                item.SetMetadata("PackageVersion", resolvedAssembly.Package.Version.ToString().ToLower());
